    ...
    const fetchDocument = async () => {
      try {
        ...
        try {
          ...
          if (!id) return;
          const response = await apiService.documents.getSubmissionById(id as string);
        ...
        try {
          ...
          if (!id) return;
          const response = await apiService.documents.getById(id as string);
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2">
              {documentUrl || (document.files && document.files[activeFileIndex]) ? (
                <DocumentViewer 
                  ...
                  filePath={document.files && document.files[activeFileIndex]?.path}
                />
              ) : (
